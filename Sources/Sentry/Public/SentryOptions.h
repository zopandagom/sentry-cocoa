 ...
 * crash event when your app crashes. When trace-based profiling is enabled by setting a
 * profilesSampleRate, the SDK will attach the profile to the trace.
 *
 * @note The default is @c NO .
 */
@property (nonatomic, assign) BOOL enableTracingForCrashes;
