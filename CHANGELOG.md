...
### Note: Due to a bug (#4280) introduced in this release, we recommend upgrading to [8.34.0](https://github.com/getsentry/sentry-cocoa/releases/tag/8.33.0) or newer.
